// Code Reference https://github.com/Rob--W/cors-anywhere/blob/master/lib/rate-limit.js

const createRateLimitChecker = (CORSANYWHERE_RATELIMIT) => {
  ...
  const accessedHosts = Object.create(null);
  setInterval(
